...
>
    <Text>{isEditing ? 'save' : 'edit'}</Text> {/* Adicionando o texto ao botão */}
</Pressable>
...
<ButtonContainer onPress={() => router.push('/ia')}>
    <Icone source={require('../../assets/ia.png')} />
</ButtonContainer>

<ButtonContainer onPress={() => router.push('/(groups)')}>
    <Icone source={require('../../assets/botao-de-inicio.png')} />
</ButtonContainer>

<ButtonContainer onPress={() => router.push('/sinonimos')}>
